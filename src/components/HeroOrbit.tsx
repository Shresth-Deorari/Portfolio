...
const HeroOrbit = ({children ,size, rotation, spinDuration, orbitDuration, shouldOrbit=false, shouldSpin=false} 
      : PropsWithChildren<{size:Number, rotation:Number, spinDuration?:string, orbitDuration?:string, shouldOrbit?:Boolean, shouldSpin?:Boolean}>) => {
  return (
